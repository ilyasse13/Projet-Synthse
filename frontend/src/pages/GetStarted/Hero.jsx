...
Welcome to Resident Connect, your private social media platform designed exclusively for residents of our community. Connecting with your neighbors has never been easier!
      ...
      <div className="mt-4 md:mt-8">
        <Link
          to="/Signup"
          className="inline-block rounded bg-slate-700 px-12 py-3 text-sm font-medium text-white transition hover:bg-slate-800 focus:outline-none focus:ring focus:ring-gray-200"
        >
          Get Started 
        </Link>
      </div>
